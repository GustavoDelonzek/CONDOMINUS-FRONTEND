...
export function Reservations() {
  ...
  const selectedRes = MOCK_RESERVATIONS.find(r => r.id === selectedResId) || MOCK_RESERVATIONS[0];
    ...
    <div className="flex flex-col h-full bg-background overflow-hidden relative">
      ...
      <div className="flex-1 flex overflow-hidden">
        {activeTab === 'reservations' ? (
          <>
            {/* Left Panel: List */}
            <div className="w-[340px] flex flex-col bg-card border-r border-border shrink-0 z-10">
            ...
            <div className="flex-1 flex flex-col bg-background min-w-0 border-r border-border relative">
              <div className="absolute top-6 right-8 flex gap-3 z-10">
                  <button className="px-6 py-2 bg-background border border-red-500 text-red-500 text-sm font-bold rounded-lg hover:bg-red-50 transition-colors flex items-center gap-2">
                    <span className="text-lg leading-none">&times;</span> Rejeitar
                  </button>
                  <button className="px-6 py-2 bg-green-500 text-white text-sm font-bold rounded-lg hover:bg-green-600 transition-colors flex items-center gap-2 shadow-sm">
                    <span className="text-base leading-none">&#10003;</span> Aprovar Reserva
                  </button>
              </div>

              <div className="flex-1 overflow-y-auto p-6 lg:p-10 custom-scrollbar">
                <div className="max-w-4xl">
                  <div className="flex justify-between items-start mb-8 pr-[300px]">
                     <div>
